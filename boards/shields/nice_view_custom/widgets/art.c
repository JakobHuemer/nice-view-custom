...
#ifndef LV_ATTRIBUTE_IMG_CORNE_CALIBRATION
#define LV_ATTRIBUTE_IMG_CORNE_CALIBRATION
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_CORNE_CALIBRATION uint8_t corne_calibration_map[] = {
    0xfe,
    0xfe,
    0xfe,
    0xff, /*Color of index 0*/
...
const lv_img_dsc_t corne_calibration = {
    .header.cf = LV_IMG_CF_INDEXED_1BIT,
    .header.always_zero = 0,
    .header.reserved = 0,
    .header.w = 140,
